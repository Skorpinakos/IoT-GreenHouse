try:
    ...
    ### input section
    dt=sys.argv[1] # set input (normally this would come from sys call args[1] and follows the yyyy_mm_dd_hh_mm_ss format)
    ###
    ...
    print("Unexpected error occured at edge AI, details bellow:\n")
    print(e)
    exit(1)
