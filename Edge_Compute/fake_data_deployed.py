...
def make_multiple_fakes(config_dict,with_file):
    ...
    while (moment<end_of_dates_unix):
        ...
        dt= datetime2dt(dt)
        make_measurement(dt,config_dict,moment,with_file)
...
#make_multiple_fakes(config_dict,True)
...
make_measurement(dt,config_dict,unix_time,True)
